...
class result(models.Model):
    ...
    one = models.CharField(max_length=20, blank=True, null=True)
    two = models.CharField(max_length=20, blank=True, null=True)
    three = models.CharField(max_length=20, blank=True, null=True)
    four = models.CharField(max_length=20, blank=True, null=True)
    five = models.CharField(max_length=20, blank=True, null=True)
    six = models.CharField(max_length=20, blank=True, null=True)
    seven = models.CharField(max_length=20, blank=True, null=True)
    eight = models.CharField(max_length=20, blank=True, null=True)
